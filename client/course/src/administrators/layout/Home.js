                    ...
                    <div className="row">
                            ...
                            <div className="card direct-chat direct-chat-primary">
                                <div className="card-header">
                                    ...
                                    <div className="card-tools">
                                        ...
                                        <button type="button" className="btn btn-tool" data-card-widget="remove"><i className="fa fa-times"></i>
                                        </button>
                                    </div>
                                </div>
                                <div className="card-body">
                      ...
                      To Do List
                                ...
                                <div className="card-footer clearfix">
                                    <button type="button" className="btn btn-info float-right"><i className="fa fa-plus"></i> Add item</button>
                                </div>
                            </div>
                        </section>
